...
public class Lec07MapCacheTest extends BaseTest {
    ...
    public void mapCacheTest() {
        ...
        Student student2 = new Student("young", 30, "miami", List.of(10, 20, 30));

        Mono<Student> st1 = mapCache.put(1, student1, 5L, TimeUnit.SECONDS);
        Mono<Student> st2 = mapCache.put(2, student2, 10L, TimeUnit.SECONDS);
