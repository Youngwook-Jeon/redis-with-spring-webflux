...
import com.young.redisson.test.dto.GeoLocation;
import com.young.redisson.test.dto.Restaurant;
import com.young.redisson.test.util.RestaurantUtil;
...
public class Lec17GeoSpatialTest extends BaseTest {
    ...
    @Test
    public void search() {
        Mono<Void> mono = this.map.get("75007")
